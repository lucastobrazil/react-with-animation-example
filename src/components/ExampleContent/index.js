...
export default function ExampleContent() {
    return (
        <div className="ExampleContent">
            ...
            <small>
                Hint: open the console and watch as the CSS classes are added/removed at the end of the animation
            </small>
            <Section>
            ...
            <Section>
                ...
                <small>
                    Animation classes placed on a wrapper, children passed in. Check{' '}
                    <a href="https://github.com/SmallImprovements/react-with-animation">the docs</a>.
                </small>
            </Section>
        </div>
    );
